                ...
                <div className="middle d-flex justify-content-between">
                  ...
                  <div className="submit-ticket-main">
                    <div className="top">
                      <h5>Submit Ticket</h5>
                      <p>
                      We’re here to help! Please use this form to share your concerns, report an issue, or request assistance. Provide as much detail as possible so we can address your ticket promptly and effectively. Your feedback helps us serve you better!
                      </p>
                    </div>
