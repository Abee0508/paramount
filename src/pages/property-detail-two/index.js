            ...
            <div className="row align-items-center">
              ...
              <div className="col-md-6">
                <div className="text">
                  ...
                  Private office with your own locked door. Shared reception area with other 3 other tenants. Brand new paint and fresh carpeting.
                  </p>
            ...
            <div className="additional-text mt-4">
              <div className="mb-5">
                <h5 className="sub-text mb-3">Property Overview:</h5>
                      <p className="paragraph">
                      1 or 3 professional office suites available for lease on the 1st floor depending on your needs. 2nd floor has 1 professional Office available. Space can be customized to fit
                      your business needs.
                      </p>
